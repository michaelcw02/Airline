    ...
    <body class="benchmarks-body">
        ...
        <div class="container body-container">
            <div class="">
                <article>
                    <div>
                        <p class="text-big text-justify">There are many ways Star Airlines gives back to the communities it serves, but one way you might not think
                        ...
                        <div>
                            <div class="row text-big">
                                <div class="panel panel-primary panel-transparent col-sm-12 col-md-4">
                        ...
                        <hr>
                        <h2 class="bold">Beyond flying. Social responsibility</h2>
                        <div>
                            <div class="row">
                                <p class="text-big text-justify">We assume our Social Responsibility through an ongoing commitment of contribution to interest groups via
                        ...
                        <hr>
                        <h2 class="bold">Our awards and acknowledgements </h2>
                        <div>
                            <div class="row">
