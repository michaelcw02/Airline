    ...
    <body>
                    ...
                    <div class="modal-body" id="myModalMessage">
                        <form role="form" onsubmit="return false;" id="formTypeAirplane">
                            ...
                            <div class="form-group" id="departureCity">
                                ...
                                <input type="text" class="form-control" id="departureCity" placeholder="Departure city id">
                            </div>

                            <div class="form-group" id="arrivalCity">
                                <label for="arrivalCity">Arrival City:</label>
                                <input type="text" class="form-control" id="arrivalCity" placeholder="Arrival city id">
                            </div>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <center>
                    <button type="button" class="btn btn-primary centered" data-toggle="modal" data-target="#myModalFormulario" id="btMostarForm">Insert</button>
                </center><br>
                <div class="col-sm-12">
